...
function Login() {
    ...
    const onSubmit = () => {
        ...
        if (valid) {
            ...
            requestApi('/shop/login','POST',loginData).then((res)=> {
                console.log(res)
                localStorage.setItem('x-client-id',res.data.metadata.shop._id)
                localStorage.setItem('access_token',res.data.metadata.tokens.accessToken)
                localStorage.setItem('refresh_token',res.data.metadata.tokens.refreshToken)
                ...
                if (typeof err.response !== "undefined") {
                    ...
                    toast.error('Server is down , please try again', { position : 'top-right'})
                }
            })
            // dispatch(actions.controlLoading(true))
